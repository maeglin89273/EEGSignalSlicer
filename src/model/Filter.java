...
public class Filter {
    ...
    public static final Filter NOTCH_60HZ = new Filter(NOTCH_60HZ_A, NOTCH_60HZ_B);
    ...
    public static final Filter BANDPASS_1_50HZ = new Filter(BANDPASS_1_50HZ_A, BANDPASS_1_50HZ_B);
    ...
    public static final Filter BANDPASS_7_13HZ = new Filter(BANDPASS_7_13HZ_A, BANDPASS_7_13HZ_B);
    ...
    public static final Filter BANDPASS_15_50HZ = new Filter(BANDPASS_15_50HZ_A, BANDPASS_15_50HZ_B);

    private double[] a;
    private double[] b;
    private Filter(double[] a, double[] b) {
        this.a = a;
        this.b = b;
    }
