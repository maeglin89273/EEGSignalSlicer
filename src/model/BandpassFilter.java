...
public class BandpassFilter implements Filter {
    ...
    public static final BandpassFilter NOTCH_60HZ = new BandpassFilter(NOTCH_60HZ_A, NOTCH_60HZ_B);
    ...
    private static final double[] BANDPASS_1_50HZ_B = {2.001387256580675e-001, 0.0, -4.002774513161350e-001, 0.0, 2.001387256580675e-001};
    public static final BandpassFilter BANDPASS_1_50HZ = new BandpassFilter(BANDPASS_1_50HZ_A, BANDPASS_1_50HZ_B);
    ...
    public static final BandpassFilter BANDPASS_7_13HZ = new BandpassFilter(BANDPASS_7_13HZ_A, BANDPASS_7_13HZ_B);
    ...
    public static final BandpassFilter BANDPASS_15_50HZ = new BandpassFilter(BANDPASS_15_50HZ_A, BANDPASS_15_50HZ_B);
